...
from .kriging.kriging_loss import KrigingLoss
...
class SegNet(nn.Module):
    ...
    Args:
        output_channels (int): number of classes to segment
        input_channels (int): number of input features in the fist convolution
    ...
    """
    def __init__(self, input_channels, output_channels, use_kriging_loss=False):
        ...
        encoder_filter_config = (input_channels,) + filter_config
        ...
        self.classifier = nn.Sequential(nn.Conv2d(filter_config[0], output_channels, 3, 1, 1),
                        nn.Sigmoid()
                        )
